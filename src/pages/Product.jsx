      ...
      {findProduct ? (
        <>
          ...
          <div className="">
            ...
            <br />
            <button className="bg-green-600 hover:bg-green-800 text-white border-none px-4 py-2">
              Add to Bag
            </button>
          </div>
         ...
         <div className="">
          ...
          <RelatedProducts category={findProduct.category} subcategory ={findProduct.subCategory} />
         </div>
        </>
      ) : (
